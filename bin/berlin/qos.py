...
def create_qos_qdisc( C, file=False ):
    ...
    for ifc in ifaces:
        ...
        rules += [
            ...
            ['class','add','dev',ifn,'parent','1:1', 'classid','1:10','htb','rate',k(5*unit),'ceil',k(10*unit),'prio','0'],
            ['class','add','dev',ifn,'parent','1:1', 'classid','1:11','htb','rate',k(7*unit),'ceil',k(  ceil ),'prio','1'],
            ['class','add','dev',ifn,'parent','1:1', 'classid','1:12','htb','rate',k(7*unit),'ceil',k(  ceil ),'prio','2'],
            ['class','add','dev',ifn,'parent','1:1', 'classid','1:13','htb','rate',k(2*unit),'ceil',k(  ceil ),'prio','3'],
            ['class','add','dev',ifn,'parent','1:1', 'classid','1:14','htb','rate',k(2*unit),'ceil',k(  ceil ),'prio','3'],
            ['class','add','dev',ifn,'parent','1:1', 'classid','1:15','htb','rate',k(1*unit),'ceil',k(  ceil ),'prio','4'],
            ['class','add','dev',ifn,'parent','1:1', 'classid','1:16','htb','rate',k(3*unit),'ceil',k(  ceil ),'prio','4'],
            ...
            ['filter','add','dev',ifn,'parent','1:0','protocol','ip','prio','1','handle','1','fw','classid','1:10'],
            ['filter','add','dev',ifn,'parent','1:0','protocol','ip','prio','2','handle','2','fw','classid','1:11'],
            ['filter','add','dev',ifn,'parent','1:0','protocol','ip','prio','3','handle','3','fw','classid','1:12'],
            ['filter','add','dev',ifn,'parent','1:0','protocol','ip','prio','4','handle','4','fw','classid','1:13'],
            ['filter','add','dev',ifn,'parent','1:0','protocol','ip','prio','5','handle','5','fw','classid','1:14'],
            ['filter','add','dev',ifn,'parent','1:0','protocol','ip','prio','6','handle','6','fw','classid','1:15'],
            ['filter','add','dev',ifn,'parent','1:0','protocol','ip','prio','7','handle','7','fw','classid','1:16'],
